...
def listar(arg=0):
    try:
        ...
        for cell in cells:
            ...
            print('extraindo as informacoes detalhadas desta celula'); arqsys.write('Extraindo as informacoes detalhadas desta celula\n')
            for node in nodes:
            ...
            for server in servers:
                ...
                for app in apps:
                    if app == app1:
                        ...
                        if objName == '':
                            AdminControl.invoke(appManager,'statusApplication',app1)
